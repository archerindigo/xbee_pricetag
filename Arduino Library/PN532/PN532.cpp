...
/*
 * Customer function to shutDown the module
 */
bool PN532::shutDown(){
    pn532_packetbuffer[0] = PN532_COMMAND_POWERDOWN;
    pn532_packetbuffer[1] =  0x90; //(0x20, for SPI) (0x90, for I2C and HSU) (0x28 for SPI and RF detectionThe wakeup source(s) you want too use
